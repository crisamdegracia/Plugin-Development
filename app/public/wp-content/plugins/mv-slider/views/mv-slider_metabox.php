...
<table class="form-table mv-slider-metabox"> 
    <!-- 
    Etong hidden input field hidden para sa security feature.
    ung echo wp_create_nonce() ung nasa loob non  e name ng NONCE 
    gagamitin to para dun sa save_post() for authentication
    -->
